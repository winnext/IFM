...
exports.ClassificationNotFountException = exports.FacilityStructureNotFountException = exports.FacilityNotFountException = void 0;
...
function FacilityStructureNotFountException(id) {
    throw new common_1.HttpException({ key: i18n_enum_1.I18NEnums.FACILITY_NOT_FOUND, args: { id: id } }, common_1.HttpStatus.NOT_FOUND);
}
exports.FacilityStructureNotFountException = FacilityStructureNotFountException;
