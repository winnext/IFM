...
import { createDynamicCyperCreateQuery, updateNodeQuery } from './func/common.func';
...
import {
  add_children_relation_by_id_error,
  ...
  create_node_with_label_add_parent_by_labelclass_error,
  create_node_with_label__must_entered_error,
  create_node_with_label__node_not_created_error,
  create_node__must_entered_error,
  create_node__node_not_created_error,
  create__must_entered_error,
  deleteParentRelationError,
  delete_children_nodes_by_id_and_labels__not_deleted_error,
  ...
  add_relation_must_entered_error,
  ...
  add_children_relation_by_id__relationship_not_created,
...
export class Neo4jService implements OnApplicationShutdown {
  ...
  async findNodeCountByClassName(
    //DİKKAT1   önceki isminde ilave olarak withoutChildren vardı.
    class_name: string,
  ...
  async findRootNodeByClassName(params: findNodeCountByClassNameDto, databaseOrTransaction?: string | Transaction) {
    try {
      if (!params) {
  ...
  async findByName(name: string, databaseOrTransaction?: string | Transaction) {
    try {
      ...
      const cypher = 'MATCH (n {isDeleted: false}) where n.name = $name return n';
    ...
    try {
      ...
      if (label && label.length > 0) {
        for (let i = 0; i < label.length; i++) {
          const res = await this.write(`MATCH (c {isDeleted: false}) where id(c)= $id remove c:${label[i]}`, {
            id: parseInt(id),
          });
          resArray.push(res);
        }
  ...
  async updateLabel(id: string, label: string[]) {
    try {
      ...
      if (label && label.length > 0) {
        for (let i = 0; i < label.length; i++) {
          const res = await this.write(`MATCH (c {isDeleted: false}) where id(c)= $id set c:${label[i]}`, {
            id: parseInt(id),
          });
          resArray.push(res);
        }
  ...
  async findOneNodeByKey(key: string) {
    try {
      ...
      //find node by key
      const result = await this.read('match (n {isDeleted: false}) where n.key=$key return n', { key: key });
  ...
  async findChildrenById(id: string) {
    try {
      ...
      const cypher = 'match (n {isDeleted: false})<-[:CHILD_OF]-(p {isDeleted: false}) where id(n)=$idNum  return p';
      const result = await this.read(cypher, { idNum });
      return result;
    } catch (error) {
      if (error.response.code) {
            ...
            if (node['root']['children'][i]['children'][j]['children']) {
              for (let k = 0; k < node['root']['children'][i]['children'][j]['children'].length; k++) {
                ...
                if (node['root']['children'][i]['children'][j]['children'][k]['children']) {
                  for (
                    let l = 0;
                    l < node['root']['children'][i]['children'][j]['children'][k]['children'].length;
                    l++
                  ) {
                    ...
                    if (node['root']['children'][i]['children'][j]['children'][k]['children'][l]['children']) {
                      for (
                        let m = 0;
                        m < node['root']['children'][i]['children'][j]['children'][k]['children'][l]['children'].length;
                        m++
                      ) {
                        node['root']['children'][i]['children'][j]['children'][k]['children'][l]['children'][m][
                          'children'
                        ] =
                          node['root']['children'][i]['children'][j]['children'][k]['children'][l]['children'][m][
                            'child_of'
                          ];
                        delete node['root']['children'][i]['children'][j]['children'][k]['children'][l]['children'][m][
                          'child_of'
                        ];
                        if (
                          node['root']['children'][i]['children'][j]['children'][k]['children'][l]['children'][m][
                          ...
                          for (
                            ...
                            delete node['root']['children'][i]['children'][j]['children'][k]['children'][l]['children'][
                              m
                            ]['children'][n]['child_of'];
                            if (
                              node['root']['children'][i]['children'][j]['children'][k]['children'][l]['children'][m][
                              ...
                              for (
                                ...
                                node['root']['children'][i]['children'][j]['children'][k]['children'][l]['children'][m][
                                  ...
                                  node['root']['children'][i]['children'][j]['children'][k]['children'][l]['children'][
                                    m
                                  ]['children'][n]['children'][o]['child_of'];
                                delete node['root']['children'][i]['children'][j]['children'][k]['children'][l][
                                  'children'
                                ][m]['children'][n]['children'][o]['child_of'];
                                if (
                                  node['root']['children'][i]['children'][j]['children'][k]['children'][l]['children'][
                                    m
                                  ]['children'][n]['children'][o]['children']
                                ) {
                                  for (
                                    let p = 0;
                                    p <
                                    node['root']['children'][i]['children'][j]['children'][k]['children'][l][
                                      'children'
                                    ][m]['children'][n]['children'][o]['children'].length;
                                    p++
                                  ) {
                                    node['root']['children'][i]['children'][j]['children'][k]['children'][l][
                                      'children'
                                    ][m]['children'][n]['children'][o]['children'][p]['children'] =
                                      node['root']['children'][i]['children'][j]['children'][k]['children'][l][
                                        'children'
                                      ][m]['children'][n]['children'][o]['children'][p]['child_of'];
                                    delete node['root']['children'][i]['children'][j]['children'][k]['children'][l][
                                      'children'
                                    ][m]['children'][n]['children'][o]['children'][p]['child_of'];
                                  }
